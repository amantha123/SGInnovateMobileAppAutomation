...
public class UserPostAnUpdateTestCase extends BaseConfig {

    @Test
    public void VerifyUserPostAnUpdate() throws InterruptedException {
        ...
        MobileElement el9 = (MobileElement) driver.findElementByAccessibilityId("Post an Update");
        el9.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);
