...
public class UserViewingNotificationsPreferenceTestCase extends BaseConfig{

    @Test
    public void VerifyUserViewingNotificationPreference() throws InterruptedException {
        ...
        MobileElement el10 = (MobileElement) driver.findElementByAccessibilityId("Notifications");
        el10.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);
    }
