...
public class PostScreenTestCase extends BaseConfig {

    @Test
    public void VerifyPostScreen() throws InterruptedException {
        ...
        MobileElement el8 = (MobileElement) driver.findElementByAccessibilityId("Post");
        el8.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);

        MobileElement el9 = (MobileElement) driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View[1]/android.view.View\n");
        el9.isDisplayed();
        System.out.println("Element is displayed");
        Thread.sleep(2000);
    }
