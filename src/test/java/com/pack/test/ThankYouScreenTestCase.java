...
public class ThankYouScreenTestCase extends BaseConfig {

    @Test
    public void VerifyThankYouScreen() throws InterruptedException {
        ...
        MobileElement el10 = (MobileElement) driver.findElementByAccessibilityId("Select Recipient");
        el10.isDisplayed();
        System.out.println("Element is displayed");
        Thread.sleep(2000);

        MobileElement el11= (MobileElement) driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.EditText");
        el11.isDisplayed();
        System.out.println("Element is displayed");
        Thread.sleep(2000);
