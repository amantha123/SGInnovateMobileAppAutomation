...
public class GiftScreenTestCase extends BaseConfig {

    @Test
    public void VerifyGiftScreen() throws InterruptedException {
        ...
        MobileElement el8 = (MobileElement) driver.findElementByAccessibilityId("Gift");
        el8.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);
