...
public class UserLoginWithValidCredentialsTestCase extends BaseConfig {
    ...
    public void VerifyUserLoginWithValidCredentials() throws InterruptedException {
        ...
        MobileElement el9 = (MobileElement) driver.findElementByAccessibilityId("Log Out");
        el9.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);

        MobileElement el10 = (MobileElement) driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View");
        el10.click();
        System.out.println("Element is displayed");
        Thread.sleep(2000);

        MobileElement el11 = (MobileElement) driver.findElementByAccessibilityId("LOGOUT");
        el11.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);
    }
