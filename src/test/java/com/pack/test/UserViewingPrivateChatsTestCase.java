...
public class UserViewingPrivateChatsTestCase extends BaseConfig {

    @Test
    public void VerifyUserViewingPrivateChats() throws InterruptedException {
        ...
        MobileElement el9 = (MobileElement) driver.findElementByAccessibilityId("Private Chats");
        el9.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);
