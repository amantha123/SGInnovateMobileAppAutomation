...
public class UserViewingMyQRCodesLinksTestCase extends BaseConfig{

    @Test
    public void VerifyUserViewingMyQRCodeLinks() throws InterruptedException {
        ...
        MobileElement el9 = (MobileElement) driver.findElementByAccessibilityId("My QR Codes & Links");
        el9.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);
        ...
        MobileElement el11 = (MobileElement) driver.findElementByAccessibilityId("QR Codes\nDisplay QR codes so others can easily thank you");
        el11.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);
        ...
        MobileElement el13 = (MobileElement) driver.findElementByAccessibilityId("QR Codes\nDisplay QR codes so others can easily thank you");
        el13.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);

        MobileElement el14 = (MobileElement) driver.findElementByAccessibilityId("Copy Link(s)\nUse Links to Invite to join & Thank others");
        el14.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);
