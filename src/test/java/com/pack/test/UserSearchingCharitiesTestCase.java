...
public class UserSearchingCharitiesTestCase extends BaseConfig{

    @Test
    public void VerifyUserSearchingCharities() throws InterruptedException {
        ...
        MobileElement el9 = (MobileElement) driver.findElementByXPath("//android.widget.ImageView[@content-desc=\"Charities\"]");
        el9.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);
