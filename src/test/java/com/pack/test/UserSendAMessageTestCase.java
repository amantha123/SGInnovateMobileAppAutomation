...
public class UserSendAMessageTestCase extends BaseConfig {

    @Test
    public void VerifyUserSendAMessage() throws InterruptedException {
        ...
        MobileElement el9 = (MobileElement) driver.findElementByAccessibilityId("Send a Message");
        el9.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);
