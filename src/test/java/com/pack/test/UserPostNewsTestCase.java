...
public class UserPostNewsTestCase extends BaseConfig {

    @Test
    public void VerifyUserPostNews() throws InterruptedException {
        ...
        MobileElement el9 = (MobileElement) driver.findElementByAccessibilityId("Post News");
        el9.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);
