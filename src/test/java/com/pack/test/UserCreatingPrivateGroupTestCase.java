...
public class UserCreatingPrivateGroupTestCase extends BaseConfig{

    @Test
    public void VerifyUserCreatingPrivateGroup() throws InterruptedException {
        ...
        MobileElement el9 = (MobileElement) driver.findElementByXPath("//android.widget.ImageView[@content-desc=\"Private Groups\"]");
        el9.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);
        ...
        MobileElement el12 = (MobileElement) driver.findElementByAccessibilityId("OK");
        el12.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);
