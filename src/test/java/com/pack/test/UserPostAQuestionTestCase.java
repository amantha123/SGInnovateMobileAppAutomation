...
public class UserPostAQuestionTestCase extends BaseConfig {

    @Test
    public void VerifyUserPostAQuestion() throws InterruptedException {
        ...
        MobileElement el9 = (MobileElement) driver.findElementByAccessibilityId("Post a Question");
        el9.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);
