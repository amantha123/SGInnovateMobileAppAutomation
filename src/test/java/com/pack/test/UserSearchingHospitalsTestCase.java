...
public class UserSearchingHospitalsTestCase extends BaseConfig{

    @Test
    public void VerifyUserSearchingHospitals() throws InterruptedException {
        ...
        MobileElement el9 = (MobileElement) driver.findElementByXPath("//android.widget.ImageView[@content-desc=\"Hospitals\"]");
        el9.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);
        ...
        MobileElement el11 = (MobileElement) driver.findElementByAccessibilityId("Royal");
        el11.isDisplayed();
        System.out.println("Element is displayed");
        Thread.sleep(2000);
    }
