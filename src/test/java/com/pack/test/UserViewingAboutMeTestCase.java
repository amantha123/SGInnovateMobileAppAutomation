...
public class UserViewingAboutMeTestCase extends BaseConfig{

    @Test
    public void VerifyUserViewingAboutMe() throws InterruptedException {
        ...
        MobileElement el11 = (MobileElement) driver.findElementByAccessibilityId("Log Out");
        el11.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);

        MobileElement el12 = (MobileElement) driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View");
        el12.isDisplayed();
        System.out.println("Element is displayed");
        Thread.sleep(2000);

        MobileElement el13 = (MobileElement) driver.findElementByAccessibilityId("LOGOUT");
        el13.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);
