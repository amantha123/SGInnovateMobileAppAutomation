...
public class UserSendingThankYouMessageTestCase extends BaseConfig {

    @Test
    public void VerifyUserSendingThankYouMessage() throws InterruptedException {
        ...
        MobileElement el8 = (MobileElement) driver.findElementByAccessibilityId("Thank");
        el8.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);

        MobileElement el9 = (MobileElement) driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.EditText");
        el9.click();
        System.out.println("Element is clicked");
        Thread.sleep(2000);
        el9.sendKeys("Kavinthan");
        System.out.println("Text is entered");
        Thread.sleep(2000);
        driver.hideKeyboard();

        MobileElement el10 = (MobileElement) driver.findElementByAccessibilityId("Kavinthan\nAssociate Tech Lead...\nShareGratitude");
        el10.isDisplayed();
        System.out.println("Element is displayed");
        Thread.sleep(2000);
        el10.click();
        ...
        MobileElement el13 = (MobileElement) driver.findElementByAccessibilityId("No");
        el13.isDisplayed();
        System.out.println("Element is displayed");
        Thread.sleep(2000);
        el13.click();
        ...
        MobileElement el14 = (MobileElement) driver.findElementByAccessibilityId("Not Now");
        el14.isDisplayed();
        System.out.println("Element is displayed");
        Thread.sleep(2000);
        el14.click();
